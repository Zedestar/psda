...
import make_difference_today_data from "./make_difference_today_data";
// import RectangularRoundedButton from "../../components/button/rectangular-rounded-button";
import FullRoundedButton from "../../components/button/full-rounded-button";
import method_of_contributing from "./method_of_contributing";
    ...
    <Container>
      ...
      <MinContainer>
        <MinContianerInsideContent>
          <AiOutlineHeart className="text-5xl text-blue-400 " />
        </MinContianerInsideContent>
        {make_difference_today_data.map((item) => (
          <FaceCard item={item} />
        ))}
        <MinContianerInsideContent>
          <FullRoundedButton
      ...
      <GridOrganizerContainer>
        {method_of_contributing.map((item) => (
