import { AiOutlineBank, AiOutlinePhone, AiOutlineFire } from "react-icons/ai";

const method_of_contributing = [
  {
    id: 1,
    icon: <AiOutlineFire className="text-3xl text-blue-500" />,
  ...
  {
    id: 2,
    icon: <AiOutlinePhone className="text-3xl text-blue-500" />,
    title: "Mobile Money",
  ...
  {
    id: 3,
    icon: <AiOutlineBank className="text-3xl text-blue-500" />,
    title: "Bank Transfer",
