...
function Contacts() {
  return (
    <Container>
      ...
      <div className="flex flex-col md:flex-row justify-between px-5 gap-2 bg-rose-300 w-full">
        <div className="bg-white w-2/3"> content one</div>

        <div className="bg-white w-1/3"> content two</div>
      </div>
