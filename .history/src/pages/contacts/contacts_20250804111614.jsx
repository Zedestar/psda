          ...
          <div className="flex flex-col gap-4">
            <ul className="bg-white border border-gray-200 shadow-lg p-4 rounded-md space-y-2">
              ...
              <li className="flex flex-row items-center justify-between">
                <p
                  className="text-gray-500 text-sm md:text-md w-1/2
                "
                >
                  Monday-Friday
                </p>
                <p className="font-bold text-sm md:text-md text-gray-600 w-1/2">
                  9:00 AM - 5:00 PM
                </p>
              </li>
              <li className="flex flex-row items-center justify-between">
              ...
              <div className="flex flex-row bg-rose-50 p-3 rounded-md mx-4">
                <p className="text-gray-600">
                  <strong className="text-gray-700 text-sm">Note:</strong> We
                  respond to emails and voicemails within 24 hours during
                  business days
                </p>
              </div>
            </ul>
