    ...
    <div className="w-full h-full py-5 ">
      ...
      <div className="flex mx-12">
        {mission_vission_impact_data.map((item) => (
          <div className="border flex flex-col mx-4 space-y-4 p-4 rounded-lg text-center hover:shadow-slate-800 bg-white">
            <div className="flex items-center justify-center rounded-full bg-green-200 w-20 h-20">
              <p>hey</p>
            </div>
