...
const core_objectives_data = [
  ...
  },
  {
    ...
    icon: <AiOutlineBulb className="text-2xl text-purple-500" />,
    color: "bg-purple-50",
  ...
  },
  {
    ...
    icon: <AiOutlineTool className="text-2xl text-yellow-500" />,
    color: "bg-yellow-50",
  ...
  },
  {
    ...
    icon: <AiOutlineStar className="text-2xl text-pink-500" />,
    color: "bg-pink-50",
