function SecondaryCard({ item }) {
  return (
    <div className="border flex flex-col justify-center mx-4 my-3 h-82 w-82 space-y-2 px-2 py-6 rounded-lg text-start max-w-lg hover:scale-105 transition  bg-white">
