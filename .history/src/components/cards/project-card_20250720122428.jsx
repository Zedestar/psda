  ...
  return (
    <div className="rounded-lg h-fit border space-y-5 hover:scale-105 transition overflow-hidden">
      <div
        ...
        style={{
          backgroundImage: "url('public/images/psdas.jpg')",
        }}
      >
        <div className="flex items-center justify-center  space-x-2">
          <p className="border bg-blue-400 text-white w-10 rounded-full p-2">
            Active
          </p>
          <p className="border bg-transparent rounded-full p-2">Cultural</p>
        </div>
      </div>
      <div>
