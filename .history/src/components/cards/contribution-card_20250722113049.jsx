...
function ContributionCard({ item }) {
  return (
    <div
      className={`border flex flex-col justify-center mx-1 my-1 space-y-1 px-4 py-5 rounded-lg text-center max-w-lg hover:shadow-lg transition ${item.cardBgColor}`}
    >
