function LeadersCard({ item }) {
  return (
    <div className="border flex flex-col justify-center mx-4 my-3 space-y-4 px-4 py-12 rounded-lg text-center max-w-lg hover:shadow-lg transition  bg-white">
      <div className="w-full flex items-center justify-center bg-gradient-to-br from-cyan-400 to-emerald-500">
        <div className="flex items-center justify-center text-3xl rounded-full w-20 h-20">
          {item.initials}
        </div>
      </div>
