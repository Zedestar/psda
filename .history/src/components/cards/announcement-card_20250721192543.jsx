  ...
  return (
    <div className="flex flex-col bg-white mx-4 p-4 rounded-lg shadow-sm hover:shadow-lg hover:scale-105 transition w-11/12 space-y-4">
      <div className="flex items-center justify-between space-x-2  ">
        <div>
          <p className="bg-green-300 text-lg font-semibold border border-gray-200 p-1 w-2/12 flex items-center justify-center rounded-full text-white">
            program
          </p>
      ...
      <div className="flex space-x-3">
        <p className="bg-green-300 text-lg font-semibold border border-gray-200 px-2  flex items-center justify-center rounded-full text-white">
          program
        </p>
        <p className="bg-green-300 text-lg font-semibold border border-gray-200 p-1 w-2/12 flex items-center justify-center rounded-full text-white">
          Education
