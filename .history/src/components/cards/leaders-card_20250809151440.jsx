function LeadersCard({ item }) {
  return (
    <div className="w-[80%] border flex flex-col justify-center m-4 my-3 space-y-4 px-4 py-7 rounded-lg text-center max-w-lg hover:shadow-lg transition  bg-white">
