...
function ContributionCard({ item }) {
  return (
    <div
      className={`border border- flex flex-col justify-center mx-1 my-1 space-y-1 py-7 px-4  rounded-lg text-center max-w-lg hover:shadow-lg transition ${item.cardBgColor}`}
    >
