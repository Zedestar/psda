function SecondaryCard({ item }) {
  return (
    <div className="border flex flex-col justify-center mx-4 my-3 h-80 space-y-4 px-4 py-12 rounded-lg text-start max-w-lg hover:shadow-lg transition  bg-white">
