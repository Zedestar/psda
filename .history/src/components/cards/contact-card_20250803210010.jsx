...
function ContactCard({ item }) {
  return (
    <div
      className={`border border-solid border-gray-200 bg-white flex flex-col justify-center mx-1 my-1 space-y-2 py-8 px-4  rounded-lg text-center max-w-lg hover:shadow-lg transition `}
    >
      ...
      <p className="text-xl font-bold text-gray-500">{item.title}</p>
      <p className="text-lg font-medium text-blue-400">{item.subTitle}</p>
