...
function Header() {
  ...
  return (
    <div className="w-full items-center justify-center bg-red-300">
      <header className="flex items-center justify-between px-4 py-3 border-b border-b-gray-300 shadow-lg max-w-screen-2xl bg-black">
