...
function HomePic() {
  return (
    ...
    >
      ...
      <div>
        <button className="bg-green-400 p-4 mx-4 text-white text-2xl border border-white rounded-full hover:scale-102">
          Join our community{" "}
        </button>
        <button className="bg-blue-400 p-4 m-4 text-white border border-white text-2xl rounded-full">
          Learn More
        </button>
      </div>
    </div>
