...
const core_objectives_data = [
  {
    ...
    icon: <AiOutlineTeam className="text-4xl text-teal-500" />,
    color: "bg-teal-50",
  ...
  },
  {
    ...
    icon: <AiOutlineBulb className="text-4xl text-purple-500" />,
    color: "bg-purple-50",
  ...
  },
  {
    ...
    icon: <AiOutlineTool className="text-4xl text-yellow-500" />,
    color: "bg-yellow-50",
  ...
  },
  {
    ...
    icon: <AiOutlineStar className="text-4xl text-pink-500" />,
    color: "bg-pink-50",
  ...
  },
  {
    ...
    icon: <AiOutlineGift className="text-4xl text-red-500" />,
    color: "bg-red-50",
