...
const contactData = [
  ...
  {
    id: 2,
    icon: <AiOutlinePhone className="text-4xl text-blue-400" />,
    title: "Call Us",
    subTitle: "+255 674 723515",
  ...
  {
    id: 3,
    icon: <AiOutlineAim className="text-4xl text-blue-400" />,
    title: "Visit Us",
    subTitle: "Morogoro Manzese, street 123",
    content: "Drop by our community center during operating hours",
